...
<head>
    ...
    <title>Gudang Kain - Transaksi</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid ">
                    ...
                    <a href="{{ route('transaksi.index') }}" class="btn btn-secondary btn-icon-split" style="margin-bottom: 10px; padding: 0;">
                                ...
                                <form action="{{ route('transaksi.update', $transaksi->id_transaksi) }}" method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="id_kain" name="id_kain">
                                            ...
                                            <option value="{{ $kain->id_kain }}"{{ $transaksi->id_kain == $kain->id_kain ? 'selected' : '' }}>{{ $kain->nama_kain }}</option>
                                            @endforeach
                                          </select>
                                      </div>
                                      <div class="mb-3">
                                          ...
                                          <select class="form-select" id="jenis" name="jenis">
                                              <option value="masuk" {{ old($transaksi->jenis) == 'masuk' ? 'selected' : '' }}>Masuk</option>
                                              <option value="keluar" {{ old($transaksi->jenis) == 'keluar' ? 'selected' : '' }}>Keluar</option>
                                          </select>
                                      </div>
                                      <div class="mb-3">
                                      ...
                                      <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="ket" name="ket" value="{{ $transaksi->keterangan }}">
                                      </div>
