                    ...
                    <a href="{{ route('stok.index') }}" class="btn btn-secondary btn-icon-split" style="margin-bottom: 10px; padding: 0;">
                        ...
                        <div class="card">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Input Data Stok</h6>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('stok.store') }}" method="post">
                                    ...
                                    <div class="mb-3">
                                      ...
                                      <select class="form-select" id="id_kain" name="id_kain">
                                        @foreach($kain as $stok)
                                            <option value="{{ $stok->id_kain }}">{{ $stok->nama_kain }}</option>
                                        @endforeach
                                      </select>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                      ...
                                      <input type="date" class="form-control" id="tanggalM" name="tanggalM">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="id_pemasok" name="id_pemasok">
                                          @foreach($pemasok as $stok)
                                              <option value="{{ $stok->id_pemasok }}">{{ $stok->nama_pemasok }}</option>
                                          @endforeach
                                        </select>
                                    </div>
